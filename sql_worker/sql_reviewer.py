...
_REVIEWER_SYSTEM_PROMPT = (
    ...
    "11. If the SQL returns an aggregate over time and no explicit timeframe is present, include MIN(date) and MAX(date) (or a clarifying comment) in the output, or apply a default time-scope and state that assumption.\n\n"
    "12. Prefer human-readable attributes (name, title, label) over raw ID columns in SELECT.\n"
